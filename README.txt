...
# 或强制 IPv4 （建议使用此，否则可能连不上）
ssh -v -o AddressFamily=inet -N -R 0.0.0.0:5001:127.0.0.1:5001 root@39.96.210.211

ssh -R 0.0.0.0:8080:localhost:5001 user@39.96.210.111 -N
# 或后台运行
ssh -f -N -R 0.0.0.0:8080:localhost:5001 user@39.96.210.111
#### ssh -N -L 8080:192.168.1.100:8080 user@39.96.210.111
